...
# Notch Size
P_DYNAMIC_ISLAND_MAX_HEIGHT=270
P_DYNAMIC_ISLAND_DEFAULT_HEIGHT=70
P_DYNAMIC_ISLAND_DEFAULT_WIDTH=215
P_DYNAMIC_ISLAND_DEFAULT_CORNER_RADIUS=16

# Animation Settings
P_DYNAMIC_ISLAND_SQUISH_AMOUNT=5
...
#
P_DYNAMIC_ISLAND_VOLUME_EXPAND_WIDTH=203 # This value should match the notch size, appearence wise
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=290 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_DEFAULT_HEIGHT=14
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=17
...
#
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_WIDTH=203 # This value should match the notch size, appearence wise
P_DYNAMIC_ISLAND_BRIGHTNESS_MAX_EXPAND_WIDTH=285 # Max size when expanded
P_DYNAMIC_ISLAND_BRIGHTNESS_DEFAULT_HEIGHT=14
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_HEIGHT=17
...
P_DYNAMIC_ISLAND_MUSIC_INFO_DEFAULT_HEIGHT=60
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_HEIGHT=130
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_WIDTH=192 # This value should match the notch size, appearence wise
P_DYNAMIC_ISLAND_MUSIC_INFO_MAX_EXPAND_WIDTH=320 # Max size when expanded#
P_DYNAMIC_ISLAND_MUSIC_INFO_CORNER_RAD=12 # Corner Radius
# Resume Info
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_WIDTH=192 # This value should match the notch size, appearence wise
P_DYNAMIC_ISLAND_MUSIC_RESUME_MAX_EXPAND_WIDTH=320
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_HEIGHT=71
